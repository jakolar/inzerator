...
- [x] Pyramida KOMPLETNÍ (2026-07-09): výšky i ortho z=8..16 celá ČR
  + z=17/18 populated, border backfill hotový, z=18 @2x (512^2, 0,20 m/px).
  **418 GB / 11,0 M dlaždic** (dmpok 172 GB / 5 489 281 LERC;
  ortho 246 GB / 5 503 455 JPEG).
...
Finální pyramida měří **418 GB** (změřeno 2026-07-09 po @2x z=18 passu) —
původní odhad 10–40 GB a CX32/160 GB NVMe nestačí.

**CX32 (4 vCPU, 8 GB, ~€7,6/měs) + 500 GB Volume (~€24/měs) ≈ €32/měs** —
...
- rsync = delta sync. První plný push je **418 GB v 11 M souborech** — na
  100Mbit uploadu ~10–12 h čistého přenosu, ale metadata scan 11 M souborů
